// Bottom sheet component - BASELINE WORKING VERSION
// Recovered from last known good state before adapter experiments
...
export default function ProjectPreviewBottomSheet_BASELINE() {

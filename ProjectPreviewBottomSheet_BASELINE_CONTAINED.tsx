// Bottom sheet component - BASELINE WITH CONTAINMENT FIX
// Protected working copy with minimal spatial containment fix
// Based on: ProjectPreviewBottomSheet_BASELINE.tsx
// Change: Added maxWidth + centering to content wrapper (line 266-268)
...
export default function ProjectPreviewBottomSheet_BASELINE_CONTAINED() {
